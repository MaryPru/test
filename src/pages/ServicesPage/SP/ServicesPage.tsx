                ...
                <div className="cardsWrapper">
                    <div className="card">
                        <div className="cardDescriptionWrapper">
                            ...
                            <div className="direction">РАЗРАБОТКА МОБИЛЬНЫХ ПРИЛОЖЕНИЙ И ИНТЕГРАЦИЯ С 1С ПРЕДПРИЯТИЕ</div>
                        </div>
...
Строим устойчивые корпоративные сайты и резвые промо-лендинги. Разрабатываем web сервисы. Наши продукты выдерживают огромную нагрузку и надёжно служат клиентам.
                            </div>
                    ...
                    <div className="card">
                        <div className="cardDescriptionWrapper">
                            ...
                            <div className="description">Воплощаем птицу идеи в действующий бизнес. Анализируем концепции стартапов. Подвергаем сомнению и находим свет — выбираем то, во что искренне верим. Консультируем и прокачиваем бизнес-модель продукта. Задаём маршрут, учим летать и выпускаем в небо.
                            </div>
                    ...
                    <div className="card">
                        <div className="cardDescriptionWrapper">
                            ...
                            <div className="description">Помогаем растущему бизнесу расти быстрее, а взрослому — достойно принимать вызовы времени.
